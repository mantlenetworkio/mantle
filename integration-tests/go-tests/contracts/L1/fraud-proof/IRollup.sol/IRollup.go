...
func (_IRollup *IRollupTransactor) RejectFirstUnresolvedAssertion(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IRollup.contract.Transact(opts, "rejectFirstUnresolvedAssertion")
}

// RejectFirstUnresolvedAssertion is a paid mutator transaction binding the contract method 0x30b26075.
//
// Solidity: function rejectFirstUnresolvedAssertion() returns()
func (_IRollup *IRollupSession) RejectFirstUnresolvedAssertion() (*types.Transaction, error) {
	return _IRollup.Contract.RejectFirstUnresolvedAssertion(&_IRollup.TransactOpts)
}

// RejectFirstUnresolvedAssertion is a paid mutator transaction binding the contract method 0x30b26075.
//
// Solidity: function rejectFirstUnresolvedAssertion() returns()
func (_IRollup *IRollupTransactorSession) RejectFirstUnresolvedAssertion() (*types.Transaction, error) {
	return _IRollup.Contract.RejectFirstUnresolvedAssertion(&_IRollup.TransactOpts)
}
...
func (_IRollup *IRollupTransactor) Stake(opts *bind.TransactOpts, stakeAmount *big.Int, operator common.Address) (*types.Transaction, error) {
	return _IRollup.contract.Transact(opts, "stake", stakeAmount, operator)
}

// Stake is a paid mutator transaction binding the contract method 0x7acb7757.
//
// Solidity: function stake(uint256 stakeAmount, address operator) returns()
func (_IRollup *IRollupSession) Stake(stakeAmount *big.Int, operator common.Address) (*types.Transaction, error) {
	return _IRollup.Contract.Stake(&_IRollup.TransactOpts, stakeAmount, operator)
}

// Stake is a paid mutator transaction binding the contract method 0x7acb7757.
//
// Solidity: function stake(uint256 stakeAmount, address operator) returns()
func (_IRollup *IRollupTransactorSession) Stake(stakeAmount *big.Int, operator common.Address) (*types.Transaction, error) {
	return _IRollup.Contract.Stake(&_IRollup.TransactOpts, stakeAmount, operator)
}
