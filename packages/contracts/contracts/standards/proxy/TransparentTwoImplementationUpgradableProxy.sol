...
import "./TwoImplementationProxyUpgradable.sol";
 ...
 */
contract TransparentUpgradeableProxy is TwoImplementationProxyUpgradable {
    /**
    ...
    ) payable TwoImplementationProxyUpgradable(_logicOne,_logicTwo,_dataOne,_dataTwo) {
        _changeAdmin(admin_);
    }
     ...
     */
    function implementation(bytes32 slot) external ifAdmin returns (address implementation_) {
        implementation_ = _getImplementation(slot);
    }
