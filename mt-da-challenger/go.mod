module github.com/mantlenetworkio/mantle/mt-da-challenger
...
replace github.com/mantlenetworkio/mantle/mt-da-batcher => ../mt-da-batcher
...
require (
	...
	github.com/mantlenetworkio/mantle/mt-da-batcher v0.0.0
