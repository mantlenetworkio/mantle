...
/**
 * @title SystemConfig
 * @notice The SystemConfig contract is used to manage configuration of an Mantle network. All
...
contract SystemConfig is OwnableUpgradeable, Semver {
     ...
     *         limit in the ResourceMetering contract used by MantlePortal, to ensure the L2
