...
func (ethash *Ethash) SetBatchPeriod(bps *types.BatchPeriodStartMsg) {
	// do nothing
}
...
func (ethash *Ethash) Prepare(chain consensus.ChainReader, header *types.Header, txSetProof *types.BatchTxSetProof) error {
