...
export class CrossChainMessenger {
  ...
  //     https://github.com/mantlenetworkio/mantle/issues/2129
  //   `)
  // }
      ...
      if (receipt === null) {
        ...
        if (this.bedrock) {
          ...
          const provenWithdrawal =
            await this.contracts.l1.MantlePortal.provenWithdrawals(
  ...
  /**
   * Queries the MantlePortal contract's `provenWithdrawals` mapping
  ...
  public async getProvenWithdrawal(
    ...
    return this.contracts.l1.MantlePortal.provenWithdrawals(withdrawalHash)
  }
  ...
  populateTransaction = {
    ...
    proveMessage: async (
      ...
      return this.contracts.l1.MantlePortal.populateTransaction.proveWithdrawalTransaction(
        [
    ...
    finalizeMessage: async (
      ...
      if (this.bedrock) {
        const withdrawal = await this.toLowLevelMessage(resolved)
        return this.contracts.l1.MantlePortal.populateTransaction.finalizeWithdrawalTransaction(
          [
            withdrawal.messageNonce,
            withdrawal.sender,
            withdrawal.target,
