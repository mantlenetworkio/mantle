...
- cb19e2f9c: Moves `FINALIZATION_PERIOD_SECONDS` from the `MantlePortal` to the `L2OutputOracle` & ensures the `CHALLENGER` key cannot delete finalized outputs.
...
- 7c0a2cc37: add is IERC165 to IMantleMintableERC20
...
- 3c22333b8: Loosens the requirements for re-proving a withdrawal transaction in the `MantlePortal`
...
- 13bfafb21: Tweaks variable ordering in MantlePortal
...
- 76c8ee2d: Fix event names orderings for `MantleMintableERC20Created`
...
- b9a90f32: Rename MantleMintableTokenFactory to MantleMintableERC20Factory
...
- 5bb6f2c7: Add `MantlePortal.isOutputFinalized`
