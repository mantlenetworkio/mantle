...
export class CrossChainMessenger implements ICrossChainMessenger {
  ...
  public async getMessageProof(
    ...
    // https://github.com/tenderly/optimism/blob/c84d3450225306abbb39b4e7d6d82424341df2be/packages/contracts/contracts/L2/predeploys/BVM_L2ToL1MessagePasser.sol#L23
