...
contract MantleMintableTokenFactory_Test is Bridge_Initializer {
    ...
    function test_createStandardL2Token_succeeds() external {
        ...
        vm.expectEmit(true, true, true, true);
        emit MantleMintableERC20Created(local, remote, alice);
    ...
    function test_createStandardL2Token_remoteIsZero_succeeds() external {
        ...
        vm.expectRevert("MantleMintableERC20Factory: must provide remote token address");
        L2TokenFactory.createStandardL2Token(remote, "Beep", "BOOP");
    }
}
