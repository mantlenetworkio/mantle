...
// prepare manipulates memory cache subsidy and setups metric system.
// This function should be called before launching devp2p stack.
func prepare(ctx *cli.Context) {
	// If we're a full node on mainnet without --cache specified, bump default cache subsidy
	...
	// Cap the cache subsidy and tune the garbage collector
	var mem gosigar.Mem
