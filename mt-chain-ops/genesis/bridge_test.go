...
const (
	...
	l2BitAddress    = "0x0000000000000000000000000000000000000000"
...
func checkBalance(t *testing.T) *big.Int {
	...
	t.Log("l1 balance bit: ", l1Bit)

	t.Log("l2 balance eth: ", l2Bit)
	t.Log("l2 balance bit: ", l2Bit)
...
func TestDepositAndWithdraw(t *testing.T) {
	...
	tx, err = l1Bridge.DepositBIT(auth, big.NewInt(DECIMAL0_1), 2_000_000, []byte("0x"))
	require.NoError(t, err)
...
func setL2EthApprove(t *testing.T) {
	...
	require.NoError(t, err)
	t.Log("approve amount = ", l1BitAllowance.Int64())
