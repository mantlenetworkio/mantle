...
func (_Challenge *ChallengeTransactor) VerifyOneStepProof(opts *bind.TransactOpts, proof []byte, challengedStepIndex *big.Int, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _Challenge.contract.Transact(opts, "verifyOneStepProof", proof, challengedStepIndex, prevChallengedSegmentStart, prevChallengedSegmentLength)
}

// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x77dece10.
//
// Solidity: function verifyOneStepProof(bytes proof, uint256 challengedStepIndex, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_Challenge *ChallengeSession) VerifyOneStepProof(proof []byte, challengedStepIndex *big.Int, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _Challenge.Contract.VerifyOneStepProof(&_Challenge.TransactOpts, proof, challengedStepIndex, prevChallengedSegmentStart, prevChallengedSegmentLength)
}

// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x77dece10.
//
// Solidity: function verifyOneStepProof(bytes proof, uint256 challengedStepIndex, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_Challenge *ChallengeTransactorSession) VerifyOneStepProof(proof []byte, challengedStepIndex *big.Int, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _Challenge.Contract.VerifyOneStepProof(&_Challenge.TransactOpts, proof, challengedStepIndex, prevChallengedSegmentStart, prevChallengedSegmentLength)
}
