...
import (
	...
	bss "github.com/mantlenetworkio/mantle/mt-l1batcher/batcher"
	"github.com/mantlenetworkio/mantle/mt-node/sources"
	l2os "github.com/mantlenetworkio/mantle/mt-proposer/proposer"
	...
	"github.com/mantlenetworkio/mantle/mt-chain-ops/genesis/migration_action"
	...
	"github.com/mantlenetworkio/mantle/mt-service/backoff"
)
...
func TestMigration(t *testing.T) {
	...
	portal, err := hh.GetDeployment("MantlePortalProxy")
	require.NoError(t, err)
