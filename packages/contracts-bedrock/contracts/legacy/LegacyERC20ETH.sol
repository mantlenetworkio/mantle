 ...
 */
contract LegacyERC20ETH is MantleMintableERC20 {
    /**
     * @notice Initializes the contract as an Mantle Mintable ERC20.
     */
    constructor()
        MantleMintableERC20(Predeploys.L2_STANDARD_BRIDGE, address(0), "Ether", "ETH")
    {}
