...
func (m *mockClient) GetStateRoot(index uint64, backend Backend) (*StateRoot, error) {
	return nil, nil
}

func (m *mockClient) GetTxStatusResponse(index uint64, backend Backend) (*types.TxStatusResponse, error) {
	return nil, nil
}
