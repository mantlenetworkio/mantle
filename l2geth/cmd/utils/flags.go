...
import (
	...
	"github.com/mantlenetworkio/mantle/l2geth/common/fdlimit"
	...
	"github.com/mantlenetworkio/mantle/l2geth/ethstats"
	"github.com/mantlenetworkio/mantle/l2geth/graphql"
	"github.com/mantlenetworkio/mantle/l2geth/les"
	"github.com/mantlenetworkio/mantle/l2geth/log"
	"github.com/mantlenetworkio/mantle/l2geth/metrics"
	"github.com/mantlenetworkio/mantle/l2geth/metrics/influxdb"
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	for index, url := range urls {
		...
		log.Info("bootnodes", "id", cfg.BootstrapNodes[index].ID(),
			"string", cfg.BootstrapNodes[index].String(), "ip", cfg.BootstrapNodes[index].IP())
	}
}
