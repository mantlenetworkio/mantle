...
- Updated dependencies [dac4a9f0]
  - @mantleio/contracts-bedrock@0.5.3
...
- f08c06a8: Updates the SDK to include default bridges for the local Mantle network (31337)
...
- cb65f3d8: Beta release of the Mantle SDK
