...
import "../L1/tss/ITssGroupManager.sol";
import "../L1/tss/ITssStakingSlashing.sol";

contract TssStakingSlashingUpgrade is
    Initializable,
    OwnableUpgradeable,
    ...
    IStakingSlashing
{
    ...
    function upgradeTssStaking(uint256 _index) private{}
}
