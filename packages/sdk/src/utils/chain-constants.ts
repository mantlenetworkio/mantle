...
const getL1ContractsByNetworkName = (network: string): OEL1ContractsLike => {
  ...
  return {
    ...
    MantlePortal: '0x5b47E1A08Ea6d985D6649300584e6722Ec4B1383' as const,
...
export const CONTRACT_ADDRESSES: {
  ...
  [L2ChainID.OPTIMISM_HARDHAT_LOCAL]: {
    l1: {
      ...
      MantlePortal: '0x0000000000000000000000000000000000000000' as const,
  ...
  [L2ChainID.OPTIMISM_BEDROCK_LOCAL_DEVNET]: {
    l1: {
      ...
      MantlePortal: '0x6900000000000000000000000000000000000001' as const,
  ...
  [L2ChainID.OPTIMISM_BEDROCK_ALPHA_TESTNET]: {
    l1: {
      ...
      CanonicalTransactionChain:
        '0x0000000000000000000000000000000000000000' as const,
      BondManager: '0x0000000000000000000000000000000000000000' as const,
      MantlePortal: '0xA581Ca3353DB73115C4625FFC7aDF5dB379434A8' as const,
