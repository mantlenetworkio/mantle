...
import ICrossDomainMessenger from '@bitdaoio/contracts/artifacts/contracts/libraries/bridge/ICrossDomainMessenger.sol/ICrossDomainMessenger.json'
...
const ERR_INVALID_MESSENGER = 'BVM_XCHAIN: messenger contract unauthenticated'
