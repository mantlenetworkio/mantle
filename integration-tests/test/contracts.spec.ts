...
describe('Contract interactions', () => {
  ...
  describe('ERC20s', () => {
    ...
    it('should successfully deploy the contract', async () => {
      contract = await Factory__ERC20.deploy(100000000, 'BVM Test', 8, 'BVM')
  ...
  describe('uniswap', () => {
    ...
    before(async () => {
      ...
      const tokenA = await Factory__ERC20.deploy(100000000, 'BVM1', 8, 'BVM1')
      await tokenA.deployed()
      const tokenB = await Factory__ERC20.deploy(100000000, 'BVM2', 8, 'BVM2')
