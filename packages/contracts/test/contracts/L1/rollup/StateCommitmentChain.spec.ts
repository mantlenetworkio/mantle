...
describe('StateCommitmentChain', () => {
  ...
  before(async () => {
    ...
    await AddressManager.setAddress('BVM_Proposer', sequencer.address)
  })
  ...
  describe('deleteStateBatch', () => {
    ...
    describe('when the sender is not the BVM_FraudVerifier', () => {
      before(async () => {
        await AddressManager.setAddress(
          'BVM_FraudVerifier',
    ...
    describe('when the sender is the BVM_FraudVerifier', () => {
      before(async () => {
        await AddressManager.setAddress('BVM_FraudVerifier', sequencer.address)
      })
