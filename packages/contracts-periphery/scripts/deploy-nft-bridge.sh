...
# Step 5: deploy the Proxy for the MantleMintableERC721Factory to L2
npx hardhat deploy --tags MantleMintableERC721FactoryProxy --network $L2_NETWORK

# Step 6: deploy the MantleMintableERC721Factory to L2
npx hardhat deploy --tags MantleMintableERC721FactoryImplementation --network $L2_NETWORK
