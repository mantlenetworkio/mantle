...
var (
	...
	RunTxBatchSubmitterFlag = cli.BoolFlag{
		Name:     "run-tx-scheduler",
		Usage:    "Determines whether or not to run the tx scheduler",
		Required: true,
		EnvVar:   prefixEnvVar("RUN_TX_BATCH_SUBMITTER"),
	}
	RunStateBatchSubmitterFlag = cli.BoolFlag{
		Name:     "run-state-scheduler",
		Usage:    "Determines whether or not to run the state scheduler",
		Required: true,
		EnvVar:   prefixEnvVar("RUN_STATE_BATCH_SUBMITTER"),
	}
	SafeMinimumEtherBalanceFlag = cli.Uint64Flag{
		Name: "safe-minimum-ether-balance",
		Usage: "Safe minimum amount of ether the scheduler key " +
