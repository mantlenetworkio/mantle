...
contract MantleMintableERC721_Test is ERC721Bridge_Initializer {
    ERC721 internal L1Token;
    MantleMintableERC721 internal L2Token;
    ...
    function setUp() public override {
        ...
        L2Token = new MantleMintableERC721(
            address(L2Bridge),
            1,
            address(L1Token),
            "L2Token",
    ...
    function test_safeMint_notBridge_reverts() external {
        ...
        vm.expectRevert("MantleMintableERC721: only bridge can call this function");
