...
func (_BVMBIT *BVMBITCaller) Decimal(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _BVMBIT.contract.Call(opts, &out, "decimal")
...
//
// Solidity: function decimal() view returns(uint8)
func (_BVMBIT *BVMBITSession) Decimal() (uint8, error) {
	return _BVMBIT.Contract.Decimal(&_BVMBIT.CallOpts)
}

// Decimal is a free data retrieval call binding the contract method 0x76809ce3.
//
// Solidity: function decimal() view returns(uint8)
func (_BVMBIT *BVMBITCallerSession) Decimal() (uint8, error) {
	return _BVMBIT.Contract.Decimal(&_BVMBIT.CallOpts)
}
