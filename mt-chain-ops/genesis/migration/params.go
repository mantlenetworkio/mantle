...
var ParamsByChainID = map[int]*Params{
	1: {
		// Regenesis 4 (Nov 11 2021) contained a supply bug such that the total BVM ETH
		...
		// total supply by accidental invocations of the Saurik bug (https://www.saurik.com/mantle.html).
