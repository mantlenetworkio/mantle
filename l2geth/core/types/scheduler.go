...
func (bps *BatchPeriodStartMsg) Serialize() []byte {
	...
	buf = binary.BigEndian.AppendUint64(buf, bps.BaseHeight)
...
func (bpa *BatchPeriodAnswerMsg) GetSignData() []byte {
	...
	buf = binary.BigEndian.AppendUint64(buf, bpa.BaseHeight)
...
func (btsp *BatchTxSetProof) Serialize() []byte {
	...
	buf = binary.BigEndian.AppendUint64(buf, btsp.BaseHeight)
