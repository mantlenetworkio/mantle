...
contracts=(
  ...
  contracts/L1/MantlePortal.sol:MantlePortal
  ...
  contracts/universal/MantleMintableERC20.sol:MantleMintableERC20
  contracts/universal/MantleMintableERC20Factory.sol:MantleMintableERC20Factory
)
