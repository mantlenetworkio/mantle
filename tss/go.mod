...
require (
	...
	github.com/bitdao-io/bitnetwork/batch-submitter v0.0.0
...
require (
	...
	github.com/bitdao-io/bitnetwork/bss-core v0.0.0 // indirect
...
replace (
	github.com/bitdao-io/bitnetwork/batch-submitter v0.0.0 => ../batch-submitter
