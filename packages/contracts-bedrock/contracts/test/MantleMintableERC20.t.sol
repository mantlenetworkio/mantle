...
} from "../universal/IMantleMintableERC20.sol";
import { IERC165 } from "@openzeppelin/contracts/utils/introspection/IERC165.sol";

contract MantleMintableERC20_Test is Bridge_Initializer {
    ...
    function test_mint_notBridge_reverts() external {
        // NOT the bridge
        vm.expectRevert("MantleMintableERC20: only bridge can mint and burn");
    ...
    function test_erc165_supportsInterface_succeeds() external {
        ...
        assertEq(iface3, type(IMantleMintableERC20).interfaceId);
