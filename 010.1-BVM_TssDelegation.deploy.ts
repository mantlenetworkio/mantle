...
// @ts-ignore
import { names } from '@mantleio/contracts/dist/address-names'
import {
  deployAndVerifyAndThen,
  getContractFromArtifact,
} from './packages/contracts/src/deploy-utils'
import {awaitCondition, hexStringEquals} from "@mantleio/core-utils";
import {deploy} from "@mantleio/contracts/test/helpers";
...
const deployFn: DeployFunction = async (hre) => {
  ...
  console.log('Tss Delegation Implementation Address', Impl__TssDelegation.address)
  ...
  console.log(
    'Tss DelegationManager Implementation Address',
...
deployFn.tags = ['TssDelegation', 'upgrade']
