...
//
// Solidity: function subsidy(address owner, address spender) view returns(uint256)
func (_BitTokenERC20 *BitTokenERC20Caller) Allowance(opts *bind.CallOpts, owner common.Address, spender common.Address) (*big.Int, error) {
	var out []interface{}
	err := _BitTokenERC20.contract.Call(opts, &out, "subsidy", owner, spender)
