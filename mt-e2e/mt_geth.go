...
// MtGeth is an actor that functions as a l2 mt-geth node
...
func NewMtGeth(t *testing.T, ctx context.Context, cfg *SystemConfig) (*MtGeth, error) {
...
func (d *MtGeth) AddL2Block(ctx context.Context, txs ...*types.Transaction) (*eth.ExecutionPayload, error) {
...
func (d *MtGeth) StartBlockBuilding(ctx context.Context, attrs *eth.PayloadAttributes) (*eth.ForkchoiceUpdatedResult, error) {
	fc := eth.ForkchoiceState{
