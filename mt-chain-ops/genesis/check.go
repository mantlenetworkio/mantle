...
var (
	...
	ExpectedStorageSlots = map[common.Address]StorageCheckMap{
		...
		predeploys.MantleMintableERC20FactoryAddr: eip1967Slots(predeploys.MantleMintableERC20FactoryAddr),
		...
		predeploys.MantleMintableERC721FactoryAddr: eip1967Slots(predeploys.MantleMintableERC721FactoryAddr),
